...
stats_cut = {
    ...
    'saddlebag': [0.0, 5.0],
    'sigma_poly0': [float("nan"), float("nan")], #[1e-7, 1e-1],
    'fknee_poly0': [float("nan"), float("nan")], #[1e-4, 1e2],
    'alpha_poly0': [float("nan"), float("nan")], #[-4.0, 2.0],
    'sigma_poly1': [float("nan"), float("nan")], #[1e-5, 1e-2],
    'fknee_poly1': [float("nan"), float("nan")], #[1e-4, 1e2],
    'alpha_poly1': [float("nan"), float("nan")], #[-5.0, 3.0],
    'power_mean': [0.0, 1e10],
    'sigma_mean': [1e-5, 1e5],
    'fknee_mean': [1e-4, 1e2],
    'alpha_mean': [-4.0, 2.0],
